...
2. `Module_2_Skills_Sub_Agents` — Skills, subagents, and the orchestrator pattern for multi-agent systems; defining subagents in `.Codex/agents/`, specialization, failure modes, and the Sprint Zero capstone.
